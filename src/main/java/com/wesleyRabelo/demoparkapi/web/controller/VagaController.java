...
import com.wesleyRabelo.demoparkapi.service.VagaService;
...
import com.wesleyRabelo.demoparkapi.web.dto.mapper.VagaMapper;
...
public class VagaController {
    ...
    @Operation(summary = "Localizar uma vaga", description = "Recurso para localizar uma nova pelo seu código" +
            "Requisição exige uso de um bearer token. Uso exclusivo da ROLE= 'ADMIN'",
            security = @SecurityRequirement(name = "security"),
            responses = {
