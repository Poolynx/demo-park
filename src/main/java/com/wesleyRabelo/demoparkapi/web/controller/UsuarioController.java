...
import com.wesleyRabelo.demoparkapi.web.dto.UsuarioSenhaDto;
import com.wesleyRabelo.demoparkapi.web.dto.mapper.UsuarioMapper;
...
public class UsuarioController {
    ...
    @Operation(summary = "Recuperar um usuário pelo id", description = "Requisição exije um Bearer Token. Acesso restrito a ADMINISTRAÇÃO|CLIENTE",
    ...
    @Operation(summary = "Atualizar senha", description = "Requisição exije um Bearer Token. Acesso restrito a ADMINISTRAÇÃO|CLIENTE",
            security = @SecurityRequirement(name = "security"),
            responses = {
    ...
    @Operation(summary = "Listar todos os usuários cadastrados", description = "Requisição exije um Bearer Token. Acesso restrito a ADMINISTRAÇÃO",
            security = @SecurityRequirement(name = "security"),
            responses = {
