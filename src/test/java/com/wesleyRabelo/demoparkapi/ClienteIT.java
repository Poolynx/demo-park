...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201(){
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "60014928086"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("60014928086");
    }
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageComStatus409(){
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@gmail.com", "123456"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "39771964054"))
                .exchange()
    ...
    @Test
    public void criarCliente_ComDadosInválidos_RetornarErrorMessageComStatus422(){
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@gmail.com", "123456"))
                .bodyValue(new ClienteCreateDto("Bobb", "397.719.640-54"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void buscarCliente_ComDadosDoTokenDeCliente_RetornarClienteComStatus200(){
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("18258332066");
