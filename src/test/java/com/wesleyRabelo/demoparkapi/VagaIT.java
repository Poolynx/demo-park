...
public class VagaIT {
    ...
    @Test
    public void criarVaga_ComTipoDePerfilInvalido_RetornarErrorMessageComStatus403(){
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void criarVaga_ComVagaJáCadastrada_RetornarErrorMessageStatus409(){
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void criarVaga_ComDadosInvalidos_RetornarErrorMessageStatus422(){
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
                .bodyValue(new VagaCreateDto("A-501", "VAGO"))
                .exchange()
                .expectStatus().isEqualTo(422)
               .expectBody()
               .jsonPath("status").isEqualTo(422)
    ...
    @Test
    public void buscarVaga_ComTipoDePerfilInvalido_RetornarErrorMessageComStatus403(){
        testClient
                .get()
                .uri("/api/v1/vagas/{codigo}", "A-01")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "pedro@gmail.com", "123456"))
