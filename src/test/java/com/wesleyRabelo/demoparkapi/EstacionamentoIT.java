...
public class EstacionamentoIT {
    ...
    public void criarCheckIn_ComCpfInexistente_RetornarErrorMessageStatus404(){
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("98870115097")
                .build();
    ...
    @Test
    public void buscarCheckInPorRecibo_ComPerfilAdmin_RetornarDadosStatus200(){
        testClient
                .get()
    ...
    @Test
    public void buscarCheckInPorRecibo_ComPerfilCliente_RetornarDadosStatus200(){
        testClient
                .get()
                .uri("/api/v1/estacionamentos/check-in/20230313-101300")
    ...
    @Test
    public void buscarCheckInPorRecibo_ComReciboInexistente_RetornarErrorMessageStatus404(){
        testClient
                .get()
    ...
    @Test
    public void criarCheckOut_ComRoleInvalida_RetornarErrorMessageStatus403(){
        testClient
                .put()
                .uri("/api/v1/estacionamentos/check-out/{recibo}", "20230313-101300")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bob@email.com.br", "123456"))
    ...
    @Test
    public void buscarEstacionamentoss_PorClienteCpfComPerfilCliente_RetornarErrorMessageStatus403(){
        testClient
                .get()
    ...
    @Test
    public void buscarEstacionamentoss_DoClientedLogado_RetornarSucessoStatus200(){
    ...
    @Test
    public void buscarEstacionamentoss_DoClienteClienteLogadoComPerfilAdmin_RetornarErrorMessageStatus403(){
        testClient
                .get()
